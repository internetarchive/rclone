...
```shell
$ curl --output rclone -L https://github.com/internetarchive/rclone/releases/download/v1.62.2-vault-20230512164225-f08a6144e/rclone_1.62.2-vault-20230512164225-f08a6144e_Darwin_x86_64
$ chmod +x rclone
```
...
```shell
$ curl --output rclone -L https://github.com/internetarchive/rclone/releases/download/v1.62.2-vault-20230512164225-f08a6144e/rclone_1.62.2-vault-20230512164225-f08a6144e_Darwin_arm64
$ chmod +x rclone
```
...
* [x64 64-bit](https://github.com/internetarchive/rclone/releases/download/v1.62.2-vault-20230512164225-f08a6144e/rclone_1.62.2-vault-20230512164225-f08a6144e_Linux_x86_64)
* [ARM64](https://github.com/internetarchive/rclone/releases/download/v1.62.2-vault-20230512164225-f08a6144e/rclone_1.62.2-vault-20230512164225-f08a6144e_Linux_arm64)
