...
```shell
$ curl --output rclone -L https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Darwin_x86_64
$ chmod +x rclone
```
...
```shell
$ curl --output rclone -L https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Darwin_arm64
$ chmod +x rclone
```
...
* Rclone with Vault for Windows x64 64bit: [https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Windows_x86_64.exe](https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Windows_x86_64.exe)

In (the rare) case you have an ARM based computer running Windows, please
download: [https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Windows_arm64.exe](https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Windows_arm64.exe).
...
* [x64 64-bit](https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Linux_x86_64)
* [ARM64](https://github.com/internetarchive/rclone/releases/download/v1.59.1-vault-20221205194729-3307053cd/rclone_1.59.1-vault-20221205194729-3307053cd_Linux_arm64)
