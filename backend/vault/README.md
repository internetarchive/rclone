...
```shell
$ curl --output rclone -L https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Darwin_x86_64
$ chmod +x rclone
```
...
```shell
$ curl --output rclone -L https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Darwin_arm64
$ chmod +x rclone
```
...
* Rclone with Vault for Windows x64 64bit: [https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Windows_x86_64.exe](https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Windows_x86_64.exe)

In (the rare) case you have an ARM based computer running Windows, please
download: [https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Windows_arm64.exe](https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Windows_arm64.exe).
...
* [x64 64-bit](https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Linux_x86_64)
* [ARM64](https://github.com/internetarchive/rclone/releases/download/v1.65.1-vault-20240403162634-19a4ebdf4/rclone_1.65.1-vault-20240403162634-19a4ebdf4_Linux_arm64)
